...
namespace Identity.API.EndPoints.Authorization.Handlers;
...
public static class Exchange
{
        ...
        IOpenIddictScopeManager scopeManager)
    {
            ...
            identity.AddClaim(new Claim(OpenIddictConstants.Claims.PreferredUsername, (user.Email ?? user.UserName) ?? throw new InvalidOperationException()));
