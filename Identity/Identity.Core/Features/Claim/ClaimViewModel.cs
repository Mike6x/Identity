...
namespace Identity.Core.Features.Claim
{
    /// <summary>
    ...
    public class ClaimViewModel
    {
        ...
        /// <returns></returns>
        public static ClaimViewModel FromClaim(System.Security.Claims.Claim claim)
        {
        ...
        {
            var claim = new System.Security.Claims.Claim(this.Type, this.Value);
