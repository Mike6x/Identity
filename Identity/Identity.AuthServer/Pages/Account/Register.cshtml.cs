...
namespace Identity.AuthServer.Pages.Account;
...
) : PageModel
{
    ...
    private void PopulateRoles()
    {
        ...
        if (maxRoleLevel == AppRoleLevel.Customer) return;
        ...
        AvailableRoles = new(rolesToShow, nameof(AppRole.Name), nameof(AppRole.Name));
    }
}
