...
// {
//     public static ApplicationViewModel ToViewModel(this OpenIddictEntityFrameworkCoreApplication source)
//     {
...
public static class ClientMapping
{
    ...
    // public static OpenIddictApplicationDescriptor ToModel(this CreateApplicationCommand source)
    // {
    //     var destination = new OpenIddictApplicationDescriptor
    //     {
    //         ApplicationType = source.ApplicationType,
    ...
    // }
    //
    // public static OpenIddictApplicationDescriptor ToModel(this UpdateApplicationCommand source)
    // {
    //     var destination = new OpenIddictApplicationDescriptor
    //     {
    //         ApplicationType = source.ApplicationType,
    ...
    public static OpenIddictApplicationDescriptor ToModel(this ApplicationDto source)
    {
        var destination = new OpenIddictApplicationDescriptor
        {
            ApplicationType = source.ApplicationType,
    ...
    // The workaround is to use the MemberList.Source option which allows AutoMapper
    // to ignore the Type property.
    private static readonly Func<ApplicationDto, JsonWebKeySet?> JsonWebKeySetMapper = (a) =>
    {
        if (!string.IsNullOrEmpty(a.JsonWebKeySet))
        {
            var jsonWebKey = JsonWebKeyConverter.ConvertFromECDsaSecurityKey(GetEcDsaSigningKey(a.JsonWebKeySet));
