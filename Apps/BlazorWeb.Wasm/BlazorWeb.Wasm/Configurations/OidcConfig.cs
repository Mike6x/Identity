...
namespace BlazorWeb.Wasm.Configurations;
...
public static class OidcConfig
{
    ...
    public static IServiceCollection AddOidcConfig1(this IServiceCollection services, IConfiguration configuration, IWebHostEnvironment environment)
    {
        services.AddSecurityHeaderPolicies()
            .SetPolicySelector((PolicySelectorContext ctx) => SecurityHeadersDefinitions
                .GetHeaderPolicyCollection(configuration["OIDCSettings:Authority"], environment.IsDevelopment()));
