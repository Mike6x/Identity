...
public abstract class EntityTableContext<TEntity, TId, TRequest>
{
        ...
        Func<TEntity, bool>? canDeleteEntityFunc)
    {
        ...
        SearchAction = searchAction ?? AppActions.Search;
        CreateAction = createAction ?? AppActions.Create;
        UpdateAction = updateAction ?? AppActions.Update;
        DeleteAction = deleteAction ?? AppActions.Delete;
        ExportAction = exportAction ?? AppActions.Export;
        ImportAction = importAction ?? AppActions.Import;
